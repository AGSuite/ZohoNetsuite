  ...
  const benefits = [
    {
      ...
      points: [
        ...
        "Progressive complexity per session",
    ...
    },
    {
      ...
      points: [
        ...
        "Process walkthroughs, not just slides",
    ...
    },
    {
      ...
      points: [
        ...
        "Support ticket reduction metric",
    ...
    <div className="min-h-screen selection:bg-blue-900 selection:text-white bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/netsuiteimages/Servicesimg/traning.webp"
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-between max-w-7xl mx-auto px-4 sm:px-6 w-full pt-24 sm:pt-32 pb-8 sm:pb-10">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5 text-white/30" />
            <span className="text-white/80">Training Services</span>
          </motion.nav>
          ...
          >
            ...
            >
              ...
              >
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-blue-400">
                  Expert NetSuite Training Services
                </span>
              </motion.h1>
              ...
              >
                Maximise your NetSuite ROI with specialised training programmes.
                From end-user basics to advanced SuiteScript development and
                analytics mastery — we ensure every member of your team has the
                skills to succeed and adopt.
              </motion.p>
            ...
            >
              <div className="relative w-[88%] ml-auto">
                ...
                >
                  <Image
                    src="/images/Services/traning2.webp"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mt-0.5 leading-snug">
                      Certified instructors · Role-based · 95% certification
                      rate
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-[11px] mt-0.5 whitespace-nowrap">
                      Functional · Technical · Analytics · Custom Curriculum
                    </p>
                  </div>
                </motion.div>
              </div>
      ...
      <nav className="sticky top-[72px] z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-1 py-2 sm:py-4">
            {[
              { label: "What are Training Services?", href: "#what-is" },
          ...
          <div className="grid lg:grid-cols-2 gap-6 items-stretch">
            ...
            >
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-indigo-500 leading-tight">
                Bridge the Skills Gap. Drive Adoption.
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                The most sophisticated ERP in the world is only as effective as
                the people using it. NetSuite Training Services are designed to
                eliminate user frustration, eliminate workarounds, and ensure
                your staff can leverage NetSuite's full potential to drive
                measurable business results.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                AGSuite's NetSuite-certified trainers combine deep technical
                knowledge with real-world implementation experience — delivering
                hands-on, role-based programmes that get your teams productive
      ...
      >
        <div className="max-w-7xl mx-auto px-10 flex flex-col items-center gap-5">
          ...
          >
            Our NetSuite Training Services
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            12 training programmes covering every role, module, and skill level
            — from functional basics to advanced SuiteCloud development
          </motion.p>
      ...
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <style>{`
            ...
            .star-ts { position:absolute; border-radius:9999px; background:white; animation: twinkle var(--tw-dur, 3s) ease-in-out infinite var(--tw-delay, 0s), drift calc(var(--tw-dur, 3s) * 2) ease-in-out infinite var(--tw-delay, 0s); }
          `}</style>
          {[
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <h3 className="text-3xl md:text-5xl font-medium mt-6 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Why Businesses Choose AGSuite for NetSuite Training
            </h3>
          </motion.div>
                ...
                >
                  <div className="flex items-center gap-4 w-full">
                    ...
                    >
                      ...
                      {index === 1 && <Laptop size={20} />}
                      {index === 2 && <Cloud size={20} />}
                      {index === 3 && <Award size={20} />}
                      {index === 4 && <Shield size={20} />}
            ...
            <div className="grid lg:grid-cols-[3fr_2fr] gap-0 items-stretch">
              <div className="py-12 px-10 lg:px-16 flex flex-col justify-center">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-5 leading-snug">
                  How Much Do NetSuite Training Services Cost?
                </h2>
                <p className="text-white/75 text-base leading-relaxed mb-8">
                  Training is priced per session, per day, or as a monthly
                  retainer — depending on your team size, module scope, and
                  delivery format. Individual workshops start from a defined day
                  rate; full onboarding programmes are scoped with a fixed
                  curriculum and timeline. All sessions include materials,
                  sandbox access, and post-training support.
                </p>
                <div>
                  <a
                    href="#contact-form"
            ...
            <div className="relative z-10 px-10 py-16 lg:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="text-left max-w-2xl">
                <h2 className="text-3xl md:text-5xl font-black text-white mb-4 leading-tight">
                  Empower Your Team with Expert{" "}
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-300">
                    NetSuite Knowledge.
                  </span>
                </h2>
                <p className="text-white/80 text-lg md:text-xl font-medium">
                  Stop leaving NetSuite ROI on the table. Let AGSuite's
                  certified trainers equip your entire organisation with the
                  skills to master NetSuite and drive adoption that sticks.
                </p>
              </div>
              <a
                href="#contact-form"
