...
export default function NetSuiteAIPage() {
  ...
  const modules = [
    ...
    { title: "Generative AI Assistant", description: "Ask questions in plain English and receive instant answers, summaries, and report generation from your NetSuite data.", image: "/images/modules/analytics_collab.png", color: "#6a2575", rgb: "95,30,105" },
            ...
            >
              <div className="space-y-4">
                <h2 className="text-3xl md:text-4xl lg:text-[40px] font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-blue-500 leading-tight">
                  Work Smarter with NetSuite Artificial Intelligence.
                </h2>
              </div>
            ...
            <div className="grid lg:grid-cols-[3fr_2fr] gap-0 items-stretch">
              ...
              <div className="relative flex items-start justify-center min-h-[340px] overflow-hidden">
                ...
                <div className="relative z-10 mt-6 w-[280px] h-[320px] lg:w-[300px] lg:h-[340px] overflow-hidden shadow-2xl" style={{ borderRadius: '50% 50% 46% 54% / 52% 48% 52% 48%' }}>
                  <Image src="/images/people/laptopgirl.webp" alt="NetSuite AI Pricing" fill sizes="(max-width: 768px) 100vw, 20vw" className="object-cover object-top" />
                </div>
              </div>
            </div>
          </motion.div>
