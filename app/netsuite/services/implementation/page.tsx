...
export default function ImplementationPage() {
  ...
  const stats = [
    ...
    { label: "Client Satisfaction", value: 98, suffix: "%", icon: Zap },
  ];
  ...
  const services = [
    {
      ...
      description:
        "In-depth discovery workshops to map your current processes, define future-state requirements, and build a prioritised project scope before a single config is touched.",
    ...
    },
    {
      ...
      description:
        "Translate business requirements into a detailed NetSuite blueprint — covering module configuration, workflow design, role architecture, and chart of accounts.",
    ...
    },
    {
      ...
      description:
        "Configure NetSuite to match your exact business rules — subsidiaries, currencies, tax codes, approval workflows, and all module settings.",
    ...
    },
    {
      ...
      description:
        "Cleanse, map, and migrate your master data and transactional history from legacy systems with zero data loss and full audit trails.",
    ...
    },
    {
      ...
      description:
        "Build bespoke SuiteScripts, custom forms, and unique workflows tailored to your industry-specific requirements within NetSuite's native framework.",
    ...
    },
    {
      ...
      description:
        "Connect NetSuite to your CRM, e-commerce, payroll, or third-party platforms using pre-built connectors and custom REST/SOAP APIs.",
    ...
    },
    {
      ...
      description:
        "Structured user acceptance testing with real business scenarios — ensuring every module, workflow, and integration works exactly as designed.",
    ...
    },
    {
      ...
      description:
        "Role-based end-user training, admin workshops, and executive walkthroughs to drive adoption and ensure lasting post-go-live success.",
    ...
    },
    {
      ...
      description:
        "A structured, zero-downtime cutover plan — from parallel run testing and final data loads to the moment you switch on NetSuite for day one.",
    ...
    },
    {
      ...
      description:
        "60 days of dedicated post-go-live support — resolving issues fast, answering user questions, and fine-tuning the system as your team settles in.",
    ...
    {
      title: "Cloud ERP Strategy",
      description:
        "Define a phased roadmap from quick-win automations to multi-year NetSuite expansion — aligned with your business objectives and growth trajectory.",
    ...
    {
      title: "Managed Post-Go-Live",
      description:
        "Optional ongoing managed services after hypercare — covering system health monitoring, bi-annual upgrade readiness, and continuous improvement.",
  ...
  const benefits = [
    {
      ...
      description:
        "Every implementation engagement is governed by a detailed statement of work with fixed scope, fixed timeline, and transparent pricing — zero surprise invoices.",
      image: "/images/lap/lap1.webp",
      points: [
        "Detailed SOW before work begins",
        "Change management process for new scope",
    ...
    },
    {
      ...
      description:
        "We use pre-built industry templates for manufacturing, distribution, retail, and services — dramatically reducing config time and ensuring best-practice setups.",
      image: "/images/people/laptopgirl.webp",
      points: [
    ...
    },
    {
      ...
      description:
        "Our proven data migration framework cleanses, validates, and loads your master data with full audit trails — so you start on NetSuite with clean, reliable data.",
      image: "/images/lap/lap3.webp",
      points: [
    ...
    {
      title: "Accelerated Go-Live Timeline",
      description:
        "Structured project management and a proven rapid-deployment methodology get your teams live faster — with parallel run testing to minimise go-live risk.",
      image: "/images/people/laptopmen2.webp",
      points: [
        "Agile sprint-based delivery",
        "Weekly status reporting",
        "Risk tracking and mitigation",
        "Phased or big-bang deployment options",
      ],
    },
    {
      title: "High-Adoption Training",
      description:
        "Role-based training paths, video walkthroughs, and embedded quick-reference guides ensure your team is confident and productive from day one.",
      image: "/images/lap/lap2.webp",
      points: [
        "Role-specific training tracks",
        "Hands-on sandbox exercises",
        "Admin and super-user certification",
        "Post-go-live Q&A sessions",
      ],
    },
    {
      title: "Dedicated Project Governance",
      description:
        "A dedicated project manager, solution architect, and NetSuite consultant assigned to your engagement — with weekly check-ins and executive steering reviews.",
      image: "/images/people/fourteam.webp",
      points: [
        "Named PM and solution architect",
        "Executive steering committee cadence",
    ...
    <div className="min-h-screen selection:bg-blue-900 selection:text-white bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/netsuiteimages/Servicesimg/finamce.webp"
            alt="Implementation Services Background"
            fill
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-between max-w-7xl mx-auto px-4 sm:px-6 w-full pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-10">
          ...
          >
            ...
            >
              ...
              >
                Go live on NetSuite faster, cleaner, and with zero surprises.
                Our proven implementation methodology covers discovery through
                hypercare — delivering a fully configured, user-adopted NetSuite
            ...
            >
              <div className="relative w-[88%] ml-auto">
                ...
                >
                  <Image
                    src="/images/netsuiteimages/Servicesimg/finamce.webp"
                    alt="NetSuite Implementation Services"
                    fill
                    className="object-cover object-center"
                    priority
                  />
                ...
                >
                  ...
                  <div>
                    <p className="text-gray-900 text-sm font-bold leading-tight">
                      Go-live up to 60% faster
                    </p>
                    <p className="text-gray-500 text-xs mt-0.5 leading-snug">
                      Fixed scope · No surprises · Hypercare included
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-[11px] mt-0.5 whitespace-nowrap">
                      Discovery · Config · UAT · Go-Live · Hypercare
                    </p>
                  </div>
                </motion.div>
              </div>
      ...
      <nav className="sticky top-[72px] z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-1 py-2 sm:py-4">
            {[
              { label: "What is NetSuite Implementation?", href: "#what-is" },
          ...
          <div className="grid lg:grid-cols-2 gap-6 items-stretch">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                it's a business transformation programme. From discovery
                workshops and configuration to data migration, UAT, and go-live
                support, every phase requires expert execution to deliver a
                system your teams love using.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                AGSuite's implementation methodology is built on hundreds of
                successful go-lives across manufacturing, distribution, retail,
                services, and not-for-profit — giving you a structured,
                risk-managed path to NetSuite that meets your timeline and
                budget.
              </p>
              <div className="pt-4">
                <a
      ...
      >
        <div className="max-w-7xl mx-auto px-10 flex flex-col items-center gap-5">
          ...
          >
            12 end-to-end services covering every phase from discovery to
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <h3 className="text-3xl md:text-5xl font-medium mt-6 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Why Businesses Choose AGSuite for NetSuite Implementation
            </h3>
          </motion.div>
            ...
            <div className="grid lg:grid-cols-[3fr_2fr] gap-0 items-stretch">
              <div className="py-12 px-10 lg:px-16 flex flex-col justify-center">
                ...
                <p className="text-white/75 text-base leading-relaxed mb-8">
                  Implementation costs depend on your organisation's size,
                  module complexity, number of integrations, and data migration
                  scope. Every project is governed by a fixed-fee statement of
                  work — so you know exactly what you're getting before we
                  start. Typical engagements cover discovery, configuration,
                  data migration, testing, training, and go-live support, with
            ...
            <div className="relative z-10 px-10 py-16 lg:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="text-left max-w-2xl">
                <h2 className="text-3xl md:text-5xl font-black text-white mb-4 leading-tight">
                  Your NetSuite Journey Starts{" "}
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-300">
                    Here.
                  </span>
                </h2>
                <p className="text-white/80 text-lg md:text-xl font-medium">
                  Join hundreds of businesses that went live on NetSuite with
                  AGSuite. Get a team that delivers on time, on budget, and with
                  adoption that lasts.
                </p>
              </div>
              <a
