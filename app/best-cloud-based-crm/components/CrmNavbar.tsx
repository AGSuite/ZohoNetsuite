      ...
      <div className="max-w-[1450px] mx-auto px-6 h-full flex items-center justify-between">
        ...
        >
          <Image
            ...
            height={70}
            priority
            className="w-[180px] sm:w-[200px] h-[60px] sm:h-[70px] object-contain"
          />
        </Link>
        ...
        <nav className="hidden lg:flex items-center gap-1">
          {navLinks.map((link) => (
            <a
              ...
              className="px-3.5 py-2 text-sm xl:text-base font-semibold text-slate-800 hover:text-blue-600 transition-colors duration-200 whitespace-nowrap rounded-lg hover:bg-slate-50 cursor-pointer"
            >
              {link.label}
            </a>
          ))}
        ...
        {/* Right: Zoho Premium Partner Logo + Mobile Button */}
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            <Image
              ...
              height={55}
              priority
              className="w-[140px] sm:w-[160px] h-[45px] sm:h-[55px] object-contain"
            />
          </Link>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white border-t border-slate-200 shadow-2xl px-6 py-5 space-y-3">
          ...
          <div className="pt-2">
            <button
              onClick={scrollToHero}
              className="w-full py-3 rounded-xl font-bold text-sm text-white bg-gradient-to-r from-orange-600 to-rose-600 text-center block shadow-md"
            >
