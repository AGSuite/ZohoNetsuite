  ...
  const benefits = [
    {
      ...
      points: [
        ...
        "Hypercare support for 60 days post go-live",
      ],
    },
    {
      ...
      points: [
        ...
        "Consolidated multi-subsidiary reporting",
      ],
    },
    {
      ...
      points: [
        ...
        "Automated scheduled reports to inboxes",
        "Embedded SuiteAnalytics Workbook",
      ],
    },
    {
      ...
      points: [
        ...
        "Automatic twice-yearly upgrades",
      ],
    },
    {
      ...
      points: [
        ...
        "Smart approval routing via SuiteFlow",
    ...
    },
    {
      ...
      points: [
        ...
        "MFA and IP-based access restrictions",
      ],
    },
  ];
    ...
    <div className="min-h-screen selection:bg-blue-900 selection:text-white bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-between max-w-7xl mx-auto px-4 sm:px-6 w-full pt-24 sm:pt-32 pb-8 sm:pb-10">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5 text-white/30" />
            <span className="text-white/80">Digital Transformation</span>
          </motion.nav>
          ...
          >
            ...
            >
              ...
              >
                Modernise your enterprise from the ground up. We replace legacy
                systems with NetSuite's unified cloud platform — automating
                processes, connecting data, and unlocking growth at scale.
              </motion.p>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mt-0.5 leading-snug">
                      Proven methodology · Zero data loss · Hypercare included
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-[11px] mt-0.5 whitespace-nowrap">
                      ERP · Cloud · AI · Integration · Analytics
                    </p>
                  </div>
                </motion.div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                reimagining how your business operates, delivers value, and
                grows. NetSuite provides the unified cloud platform, and AGSuite
                provides the expertise to make it real.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                We work with growing businesses and enterprises to replace
                disconnected legacy systems with a single, intelligent cloud ERP
                — automating workflows, unifying data, and enabling smarter
                decisions faster.
              </p>
              <div className="pt-4">
                <a
      ...
      >
        <div className="max-w-7xl mx-auto px-10 flex flex-col items-center gap-5">
          ...
          >
            12 end-to-end services that take you from legacy systems to a fully
            optimised, cloud-native NetSuite operation
          </motion.p>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <style>{`
            ...
            .star-dt { position:absolute; border-radius:9999px; background:white; animation: twinkle var(--tw-dur, 3s) ease-in-out infinite var(--tw-delay, 0s), drift calc(var(--tw-dur, 3s) * 2) ease-in-out infinite var(--tw-delay, 0s); }
          `}</style>
          {[
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <h3 className="text-3xl md:text-5xl font-medium mt-6 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Why Businesses Choose AGSuite for Digital Transformation
            </h3>
          </motion.div>
                ...
                >
                  <div className="flex items-center gap-4 w-full">
                    ...
                    >
                      ...
                      {index === 1 && <Layers size={20} />}
                      {index === 2 && <BarChart3 size={20} />}
                      {index === 3 && <Cloud size={20} />}
                      {index === 4 && <Zap size={20} />}
            ...
            <div className="grid lg:grid-cols-[3fr_2fr] gap-0 items-stretch">
              ...
              <div className="py-12 px-10 lg:px-16 flex flex-col justify-center">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-5 leading-snug">
                  How Much Does NetSuite Digital Transformation Cost?
                </h2>
                <p className="text-white/75 text-base leading-relaxed mb-8">
                  Pricing is scoped to your organisation's size, complexity, and
                  the services you need. Every engagement includes a fixed-scope
                  statement of work — no surprise invoices. Our implementations
                  typically start from a defined project fee covering discovery,
                  configuration, data migration, testing, training, and go-live
                  support, with optional ongoing managed services thereafter.
                </p>
                <div>
                  <a
                    href="#contact-form"
            ...
            <div className="relative z-10 px-10 py-16 lg:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="text-left max-w-2xl">
                <h2 className="text-3xl md:text-5xl font-black text-white mb-4 leading-tight">
                  Your Digital Future Starts{" "}
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-300">
                    Here.
                  </span>
                </h2>
                <p className="text-white/80 text-lg md:text-xl font-medium">
                  Join hundreds of businesses that modernised with NetSuite and
                  AGSuite. Replace legacy systems, automate processes, and
                  unlock real-time insight — faster than you think.
                </p>
              </div>
              <a
                href="#contact-form"
