                    ...
                    <div>
                      ...
                      <div className="w-full text-slate-900">
                        <IntlTelInput
                          ...
                          inputProps={{
                            className:
                              "w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-sm",
