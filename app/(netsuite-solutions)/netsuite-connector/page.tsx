...
import {
  Package, Zap, Globe, ArrowRight, ChevronRight, ShieldCheck,
  DollarSign, CheckCircle2, Layers, Database, Code,
  IndianRupee, ShoppingBag, ShoppingCart, Tag, HelpCircle, CreditCard
} from "lucide-react";
import dynamic from 'next/dynamic';
import { FAQ } from "@/app/components/home/FAQ";
import ContactFormDesign4 from "@/app/netsuite/components/ContactFormDesign4";

const ScrollFloat = dynamic(() => import('@/app/netsuite/solutions/components/ScrollFloat'), { ssr: false }) as any;
const RotatingText = dynamic(() => import('@/app/netsuite/solutions/components/RotatingText'), { ssr: false }) as any;
...
export default function NetSuiteConnectorPage() {
  ...
  // All Add-Ons & Connectors with updated descriptions
  const addons = [
    {
    ...
    },
    {
      ...
      link: "/netsuite-data-backup-solution",
    ...
    },
    {
      ...
      link: "/amazon-netsuite-connector",
    ...
    },
    {
      ...
      link: "/shopify-netsuite-connector",
    ...
    },
    {
      ...
      link: "/magento-2-netsuite-connector",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col" style={{ background: "linear-gradient(135deg,#000814,#000f22,#001535)" }}>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center max-w-7xl mx-auto px-4 sm:px-6 w-full pt-40 pb-20">
          <motion.nav initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="absolute top-24 sm:top-28 left-4 sm:left-6 flex items-center gap-2 text-sm font-medium z-20">
            ...
            <ChevronRight className="w-3.5 h-3.5 text-white/30" /><Link href="/netsuite-products" className="text-blue-300 hover:text-white transition-colors">Solutions</Link>
            <ChevronRight className="w-3.5 h-3.5 text-white/30" /><span className="text-white/80">NetSuite Connector</span>
          </motion.nav>
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-10 items-center mb-6" style={{ minHeight: '500px' }}>
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-3xl sm:text-4xl md:text-5xl font-medium mb-4 leading-[1.3]">
                <span className="block bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-blue-400 mb-2">Experience a smarter<br /> way to connect and manage your{' '}</span>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1.0, delay: 0.4 }} className="relative hidden lg:flex items-center justify-center" style={{ minHeight: 460 }}>
              <div className="relative w-[88%] ml-auto">
                <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/50" style={{ height: 390 }}>
                  <Image src="/images/netsuiteimages/Netsuiteaddonheroimg.jpeg" alt="NetSuite Add-Ons and Connectors" fill className="object-cover object-center" priority sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" />
      ...
      <nav className="sticky top-[72px] z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-1 py-2 sm:py-4">
            {[
              { label: "What is NetSuite Add-Ons?", href: "#what-is" },
              { label: "Add-Ons & Connectors", href: "#addons" },
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-16 py-16 lg:py-24">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                style={{ minHeight: 340 }}
              >
                <Image src="/images/netsuiteimages/netsuiteaddonsecondsec.jpeg" alt="NetSuite Add-Ons and Connectors" width={1400} height={900} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw" className="w-full h-auto rounded-xl object-contain border-4 border-indigo-200 shadow-2xl shadow-indigo-900/20" priority />
              </motion.div>
              <motion.div
              ...
              >
                <ScrollFloat
                  ...
                  toColor="#2563eb"
                >
                  Supercharger NetSuite with Purpose-Built Add-Ons
                </ScrollFloat>
                <p className="text-lg text-gray-600 leading-relaxed">
                  AGSuite's NetSuite Add-Ons and Connectors extend your NetSuite ERP with automation for the capabilities NetSuite doesn't include out of the box — commission management, disaster recovery, and multi-channel commerce integration.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Every Add-On is built as a native SuiteApp — running inside your NetSuite account with no middleware, no data lag, and no separate login required.
                </p>
                <div className="pt-4">
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-gray-600 text-base leading-relaxed mb-4 font-normal">
                          {addon.description}
                        </p>
      ...
      {/* ─────────────── PRICING SECTION ─────────────── */}
      <section id="pricing" className="py-20 relative bg-[#000d1a] overflow-hidden scroll-mt-28">
        {/* Outer dark background glow */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-blue-50 via-red-50 to-purple-50 border border-white/60 rounded-[2.5rem] p-8 sm:p-12 lg:p-16 shadow-[0_30px_70px_-15px_rgba(0,0,0,0.35)] relative overflow-hidden"
          >
            {/* Light red, blue, and purple accent blurs */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-red-200/40 rounded-full blur-3xl pointer-events-none -mr-20 -mt-20" />
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-200/40 rounded-full blur-3xl pointer-events-none -ml-20 -mb-20" />
            <div className="absolute top-1/2 left-1/4 w-80 h-80 bg-blue-200/40 rounded-full blur-3xl pointer-events-none" />

            <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center relative z-10">
              {/* LEFT COLUMN: CONTENT */}
              <div className="space-y-6 text-left">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-600/10 border border-blue-600/20 text-blue-700 text-xs sm:text-sm font-semibold uppercase tracking-wider">
                  <CreditCard className="w-4 h-4 text-blue-600" /> Subscription Pricing
                </div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-blue-950 to-indigo-900 leading-tight">
                  How Are Add-Ons Priced?
                </h2>
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed font-normal">
                  All AGSuite Add-Ons and Connectors are priced as monthly or annual SuiteApp subscriptions — with tiers based on usage volume, number of users, or connected stores. There are no per-transaction fees. Because every Add-On runs natively inside NetSuite, your existing NetSuite subscription provides the data foundation. Contact our team for a personalised quote.
                </p>
                <div className="pt-2">
                  <Link
                    href="/netsuite/contact"
                    className="inline-flex items-center gap-3 px-7 py-4 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-sm sm:text-base shadow-lg shadow-blue-600/30 hover:scale-105 transition-all duration-300 group"
                  >
                    Contact Our Team for a Personalised Quote
              ...
              >
                <div className="relative w-full h-64 sm:h-72 lg:h-80">
                  <Image
                    src="/images/netsuiteimages/addons/addons_hero.png"
                    alt="How Are Add-Ons Priced"
                    fill
      ...
      <section className="py-24 overflow-hidden relative bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className="border border-gray-200 rounded-[3rem] p-12 lg:p-24 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-10 shadow-xl"
          >
            ...
            <div className="relative z-10 text-left max-w-2xl">
              <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 leading-tight">
                Extend NetSuite — <span className="text-cyan-200">Start with an <br></br>Add-On Today.</span>
              </h2>
              <p className="text-white/80 text-lg md:text-xl leading-relaxed">
                Let our certified team help you automate commissions, protect your data, and connect your commerce channels — all inside NetSuite.
              </p>
            </div>
