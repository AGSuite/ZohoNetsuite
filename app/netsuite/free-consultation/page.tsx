            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-300 text-base sm:text-lg leading-relaxed max-w-lg">
                  Ready to scale? Book a session with our certified consultants to audit your stack, identify operational bottlenecks, and architect your tailored roadmap.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    desc: "Identify challenges & operational scaling goals"
                  },
                  {
                    step: "02",
                    title: "Strategic System Audit",
                    desc: "Review existing ERP & eliminate core bottlenecks"
                  },
                  {
                    step: "03",
                    title: "Tailored Solution Roadmap",
                    desc: "Architect a customized implementation plan"
                  },
                  {
                    step: "04",
                    title: "Senior Expert Consultation",
                    desc: "Direct deep-dive session with NetSuite experts"
                  }
                ].map((item, i) => (
                  <motion.div
                    key={i}
                ...
                <div className="relative z-10 pt-1">
                  ...
                  {submitted ? (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500 max-w-xs">Thank you for reaching out. Our certified NetSuite experts will connect with you within 24 hours.</p>
                    </motion.div>
                  ) : (
                    <form
