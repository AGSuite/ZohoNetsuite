...
export default function NetsuiteSrpPage() {
  ...
  return (
    <div className="min-h-screen selection:bg-blue-900 selection:text-white bg-white">
        ...
        <div className="relative z-20 flex-1 flex flex-col justify-end max-w-7xl mx-auto px-4 sm:px-6 w-full pt-32 sm:pt-40 md:pt-48 pb-12 sm:pb-16">
          <div className="mb-8 sm:mb-10 lg:mb-12">
            <motion.div
              ...
              className="max-w-3xl"
            >
              <div className="flex gap-4 mb-6 text-sm font-medium text-blue-400">
                {[
      ...
      <nav className="sticky top-[72px] z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-center gap-1 overflow-x-auto scrollbar-hide py-4">
            {[
              { label: "What is SRP?", href: "#what-is" },
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.2 }} className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">NetSuite Service Resource Planning (SRP) is a complete PSA solution for professional services organizations, providing a comprehensive, end-to-end services business lifecycle.</p>
              <p className="text-lg text-gray-600 leading-relaxed">Manage projects, resources, time, expenses, and billing while gaining real-time visibility into profitability and performance across your entire organization.</p>
              <div className="pt-4">
      ...
      {/* Modules */}
      <section id="modules" className="py-24 bg-gray-50 scroll-mt-36">
        <div className="max-w-7xl mx-auto px-6">
      ...
      <section id="faq" className="py-24 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden scroll-mt-36">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            ...
            <p className="text-slate-600 text-lg">Everything you need to know about NetSuite SRP</p>
          </motion.div>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
