      ...
      <nav className="sticky top-[72px] z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-1 py-2 sm:py-4">
            {[["What is NetSuite Shopify Connector?", "#what-is"], ["Capabilities", "#modules"], ["Benefits", "#benefits"], ["Services", "#services"], ["Pricing", "#pricing"], ["FAQ", "#faq"]].map(([label, href]) => (
        ...
        <div className="max-w-8xl mx-auto px-16">
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            >
              <div className="relative w-full h-full p-2 lg:p-4">
                <div className="relative w-full h-full min-h-[380px] lg:min-h-[440px] rounded-2xl overflow-hidden shadow-2xl shadow-indigo-900/15 border-4 border-indigo-100">
                  <Image
                    src="/images/Dashboard/shopify connector dashboard.jpg"
                    alt="Shopify Connector Dashboard"
                    fill
            ...
            >
              ...
              <div className="pt-4">
                <Link href="#contact-form" className="group inline-flex items-center gap-3 px-7 py-3.5 rounded-full font-bold text-sm uppercase tracking-widest text-white transition-all shadow-lg hover:shadow-xl" style={{ background: 'linear-gradient(135deg,#1e3a8a,#2563eb)' }}>
                  <span>Explore Shopify Connector</span>
                  <motion.span className="flex items-center" animate={{ x: [0, 5, 0] }} transition={{ duration: 1.2, repeat: Infinity }}><ArrowRight size={17} /></motion.span>
                </Link>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid lg:grid-cols-[3fr_2fr] gap-0 items-stretch">
              ...
              <div className="relative flex items-start justify-center min-h-[340px] overflow-hidden">
                ...
                <div className="relative z-10 mt-6 w-[280px] h-[320px] lg:w-[300px] lg:h-[340px] overflow-hidden shadow-2xl" style={{ borderRadius: '50% 50% 46% 54% / 52% 48% 52% 48%' }}>
                  <Image src="/images/people/laptopgirl3.webp" alt="Shopify Pricing" fill className="object-cover object-top" sizes="(max-width: 768px) 100vw, 33vw" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative overflow-hidden rounded-3xl shadow-2xl bg-gray-950">
            ...
            <div className="relative z-20 px-10 py-16 lg:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="text-left max-w-2xl">
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 leading-tight">Automate Shopify with NetSuite — <span className="text-cyan-200">Start Today.</span></h2>
                <p className="text-white/80 text-base md:text-lg">Eliminate manual order entry, prevent overselling, and accelerate shipping — automatically.</p>
              </div>
