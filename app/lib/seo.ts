...
> = {
  ...
  "/netsuite-planning-and-budgeting": {
    title: "NetSuite Planning & Budgeting (NSPB) | Financial Planning & Analysis | AGSuite",
    description:
      "Replace spreadsheets with NetSuite Planning & Budgeting. Driver-based budgets, rolling forecasts, live ERP actuals, and multi-entity consolidation. AGSuite NSPB experts.",
    keywords: ["NetSuite Planning and Budgeting", "NSPB", "FP&A software", "financial planning NetSuite", "budgeting software", "AGSuite NSPB"],
    category: "Financial Software",
    publishedTime: "2024-01-12T00:00:00Z",
  },
  "/netsuite-erp-solution": {
    title: "NetSuite ERP Solution — Cloud ERP for Growing Businesses | AGSuite",
    description:
      "Streamline operations with NetSuite ERP. Finance, inventory, order management, and real-time reporting in one unified cloud platform. AGSuite NetSuite ERP partner.",
    keywords: ["NetSuite ERP", "cloud ERP solution", "NetSuite ERP implementation", "ERP software India", "AGSuite ERP"],
    category: "ERP Software",
  ...
  "/netsuite-business-intelligence": {
    title: "NetSuite Business Intelligence — Real-Time Dashboards & Reports | AGSuite",
    description:
      "Make smarter decisions with NetSuite Business Intelligence. Role-based dashboards, KPI scorecards, and ad-hoc reporting connected to live ERP data.",
    keywords: ["NetSuite business intelligence", "NetSuite dashboards", "NetSuite reporting", "KPI dashboards", "AGSuite NetSuite BI"],
    category: "Business Intelligence",
