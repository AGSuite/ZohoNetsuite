          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:items-start">
            ...
            >
              <span className="inline-block text-xs font-bold tracking-[0.2em] uppercase py-2 px-4 rounded-full mb-6 text-red-400 bg-red-900/40 border border-red-800">
                Authorized Advanced Zoho Partner
              </span>
              <h1 className="text-5xl md:text-7xl font-black mb-8 leading-[1.05] tracking-tight text-white">
                Zoho <span className="text-red-500">Business</span> Integrated Solutions
              </h1>
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute top-10 -right-6 lg:-right-12 bg-red-500/30 backdrop-blur-2xl border border-white/20 p-6 rounded-3xl shadow-2xl max-w-[260px] z-30"
              >
                <div className="flex items-center gap-3 mb-3">
                   ...
                   <h4 className="text-sm font-bold text-white uppercase tracking-wider">75M+ Users</h4>
                </div>
                <p className="text-xs text-red-50/90 leading-relaxed font-medium">
                  The operating system for modern business globally.
                </p>
              </motion.div>
              ...
              >
                 <div className="flex flex-col items-center text-center">
                   <svg className="w-8 h-8 text-red-600 mb-1 opacity-40" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="space-y-4">
                <h2 className="text-red-600 font-bold uppercase tracking-wider text-sm">Introduction</h2>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-red-600 font-bold uppercase tracking-wider text-sm">Our Expertise</h2>
            <h3 className="text-4xl md:text-5xl font-black text-gray-900">Zoho Services</h3>
      ...
      <section className="py-24 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-gray-900 mt-6">Overcoming Zoho Hurdles</h3>
          </div>
      ...
      <section className="py-24 bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-gray-900 mt-6">Advantages of Our Delivery</h3>
          </div>
         ...
         <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
               ...
               <h2 className="text-3xl md:text-5xl font-bold text-white mb-8 leading-tight">
                 Empower your team with Zoho. Experience the power of 55+ integrated apps.
               </h2>
