...
> = {
  ...
  "/netsuite/next-ai": {
    title: "NetSuite Next AI | Artificial Intelligence in NetSuite | AGSuite",
    description:
      "Discover NetSuite Next AI and Artificial Intelligence in NetSuite. Streamline business processes with predictive analytics, automation, and smarter decision-making.",
    keywords: ["NetSuite Next AI", "NetSuite AI", "artificial intelligence ERP", "NetSuite machine learning", "intelligent automation", "AGSuite AI NetSuite"],
    category: "Artificial Intelligence",
    publishedTime: "2024-10-18T00:00:00Z",
    dateModified: "2026-03-27",
    canonicalUrl: "https://www.agsuitetech.com/netsuite/next-ai",
    ogImage: "https://www.agsuitetech.com/images/lap/Next AI Dashboard.webp",
    ogType: "article",
    ogSiteName: "AGSuite Technologies",
    twitterLabel1: "Est. reading time",
    twitterData1: "15 minutes",
    breadcrumbs: [
      { name: "Home", url: "https://www.agsuitetech.com/" },
      { name: "NetSuite Next AI", url: "https://www.agsuitetech.com/netsuite/next-ai" },
    ],
  },
  "/why-netsuite": {
