...
/* ----------------------------------------------------
   🌈 PASTEL MULTI-SIDE GLOW SHADOW (red + Teal + Yellow for Zoho)
---------------------------------------------------- */
const glowShadow =
...
---------------------------------------------------- */
export default function ZohoMetrics() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-700 text-base sm:text-lg md:text-xl leading-relaxed max-w-xl">
              AGSuite Technologies is a trusted Advanced Zoho Partner, delivering tailored Zoho CRM and business applications.
            </p>

            <p className="text-gray-700 text-base sm:text-lg md:text-xl leading-relaxed max-w-xl mt-4">
              We help organizations automate workflows, improve productivity, and manage operations seamlessly on a unified Zoho platform.
            </p>
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="text-center space-y-1">
                  <Users className="w-9 h-9 text-red-500 mx-auto mb-1" />
                  <Counter end={250} suffix="+" inView={metricsInView} />
                  <p className="text-red-600 text-sm">Clients</p>
                </div>

                <div className="text-center space-y-1">
                  <Wrench className="w-9 h-9 text-yellow-500 mx-auto mb-1" />
                  <Counter end={45} suffix="+" inView={metricsInView} />
                  <p className="text-yellow-600 text-sm">Integrations</p>
                </div>

                <div className="text-center space-y-1">
                  <Globe className="w-9 h-9 text-green-500 mx-auto mb-1" />
                  <Counter end={60} suffix="+" inView={metricsInView} />
                  <p className="text-green-600 text-sm">Apps</p>
                </div>

                <div className="text-center space-y-1">
                  <TrendingUp className="w-9 h-9 text-red-500 mx-auto mb-1" />
                  <Counter end={12} suffix="+" inView={metricsInView} />
                  <p className="text-red-600 text-sm">Years</p>
                </div>
          ...
          >
            ...
            <div className="block md:hidden w-full">
              ...
              >
                <Image
                  src="/images/people/heroimg.webp"
                  alt="Zoho Team"
                  width={600}
                  height={400}
