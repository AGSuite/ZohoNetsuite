      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:items-start">
            ...
            >
              <div className="w-full h-[450px] rounded-2xl bg-linear-to-br from-red-600/20 to-amber-900/20 overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(220,38,38,0.2)] relative group">
                <Image
              ...
              >
                <div className="flex items-center gap-3">
                   ...
                   <h4 className="text-base font-bold text-gray-900 tracking-wide">Zoho Suite Solutions</h4>
                </div>
              </motion.div>
