            ...
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed max-w-lg mb-10">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">+91 909 601 2100</p>
                </div>
              </div>
            </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select name="LEADCF5" required defaultValue="" onChange={(window as any).addAriaSelected409531000000325116} className="w-full bg-blue-50/30 border-2 border-transparent focus:border-blue-600 focus:bg-white rounded-xl px-4 py-3 text-gray-900 transition-all outline-none appearance-none cursor-pointer text-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select name="LEADCF40" required defaultValue="" onChange={(window as any).addAriaSelected409531000000325116} className="w-full bg-blue-50/30 border-2 border-transparent focus:border-blue-600 focus:bg-white rounded-xl px-4 py-3 text-gray-900 transition-all outline-none appearance-none cursor-pointer text-sm">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select name="LEADCF41" defaultValue="" onChange={(window as any).addAriaSelected409531000000325116} className="w-full bg-blue-50/30 border-2 border-transparent focus:border-blue-600 focus:bg-white rounded-xl px-4 py-3 text-gray-900 transition-all outline-none appearance-none cursor-pointer text-sm">
                ...
                <div className="captcha-area transform scale-[0.9] origin-left">
                  ...
                  <div id="recapErr409531000000325116" style={{ fontSize: '10px', color: 'red', marginTop: '4px', visibility: 'hidden' }}>Please verify that you are not a robot.</div>
                </div>

                {/* Submit Button */}
                <button
                  type="submit"
                  className="formsubmit-light w-full py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-xl shadow-xl shadow-blue-200 transition-all duration-300 hover:scale-[1.01] transform active:scale-[0.99] text-sm"
                >
                  Send Message Now
                </button>
              </form>
