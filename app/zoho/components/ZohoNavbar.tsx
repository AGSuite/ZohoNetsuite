...
const ZohoNavbar = () => {
  ...
  // Check specifically for Zoho solution pages or generic solution pages if needed
  const isSolutionSubpage = pathname.startsWith('/solutions/zoho/');
  ...
  const canonicalize = (s?: string) => {
    ...
    if (v === 'ZOHO') return CANON.ZOHO;
    return v;
  };

  const SECTION_LABELS: string[] = [CANON.ZOHO];
  const [openMobileSolution, setOpenMobileSolution] = useState<string>(CANON.ZOHO);
                  ...
                  <div className="mx-auto max-w-[1600px] px-5 sm:px-10 md:px-12 lg:px-5 py-8">
                    ...
                    {item.title === 'Services' && (
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="p-6 flex flex-col items-start">
                          <h3 className="text-5xl font-medium text-red-500 mb-5">Our Services</h3>
                    ...
                    {item.title === 'Industries' && (
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="p-6 flex flex-col items-start">
                          <h3 className="text-5xl font-medium text-red-500 mb-5">Industries We Serve</h3>
                          <p className="text-lg text-gray-900">
                    ...
                    {item.title === 'Insights' && (
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="p-6 flex flex-col items-start">
                          <h3 className="text-5xl font-medium text-red-500 mb-5">Insights & Resources</h3>
                    ...
                    {item.title === 'Contact' && (
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="p-6 flex flex-col items-start">
                          <h3 className="text-5xl font-medium text-red-500 mb-5">Contact Us</h3>
                          <p className="text-lg text-gray-900">Reach out for support or opportunities.</p>
                          <Link
                            href="/contact-us"
                            className="inline-block bg-red-600 text-white font-medium px-8 py-3 mt-5 rounded-lg shadow-md hover:bg-red-700 transition duration-300"
                          >
                            Contact Us
                          </Link>
                        </div>
                              ...
                              <div className="space-y-4">
                                ...
                                >
                                  {child.megaMenu?.categories.map((category, catIndex) => (
                                    ...
                                    >
                                      <h4 className="text-sm font-normal text-red-600 uppercase tracking-wide border-b border-red-200 pb-1">
                                        {category.title}
                                      </h4>
                                      <ul className="space-y-0">
                                        {category.items.map((subItem, subIndex) => (
                                          <li key={subIndex}>
                                            <Link
                                              href={subItem.href}
                                              className="block text-xs font-medium text-gray-900 hover:text-red-600 transition-colors duration-200 py-1"
                                              onClick={() => {
                                                setOpenDropdown(null);
                                                setOpenMegaMenu(null);
                                              }}
                                ...
                                {links.map((sub: { href: string; label: string }) => (
                                  <Link
                                    ...
                                    className="
                                      ...
                                      text-gray-900 border-gray-200 hover:bg-red-50 hover:text-red-600
                                    "
                                  >
                                    {sub.label}
                                  </Link>
