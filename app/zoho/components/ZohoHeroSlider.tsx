          ...
          customVisual={
            <div className="relative w-full h-full flex items-center justify-center p-4 min-h-[400px] lg:min-h-[500px]">
              <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center scale-[0.65] sm:scale-90 lg:scale-100">
                ...
                >
                  <Image src="/images/zoho-logos/zoho premium.webp" alt="Zoho Premium Partner" width={120} height={60} className="object-contain max-lg:w-auto max-lg:h-auto max-lg:max-w-full max-lg:max-h-full" style={{ width: 'auto', height: 'auto' }} sizes="120px" />
                </motion.div>
