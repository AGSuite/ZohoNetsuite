...
export default function NetSuiteServicesClient() {
  ...
  const services = [
    ...
    },
    {
      ...
      link: "/netsuite/services/integration-services",
  ...
  const industries = [
    ...
    },
    {
      ...
      icon: Code,
      href: "/netsuite/industries/software-and-technology",
    },
    {
      title: "Retail & E-Commerce",
      description: "Deliver seamless omnichannel customer experiences.",
      icon: ShoppingCart,
      href: "/netsuite/industries/retail-and-e-commerce",
    },
    {
      title: "Wholesale Distribution",
      description: "Maximize supply chain efficiency and visibility.",
      icon: Truck,
      href: "/netsuite/industries/wholesale-distribution",
    },
    {
    ...
    },
    {
      ...
      icon: MonitorPlay,
      href: "/netsuite/industries/media-and-publishing",
    },
    {
