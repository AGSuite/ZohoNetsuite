    ...
    <div className="relative">
      ...
      <div className="fixed left-8 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-4">
        <a
          ...
          className="w-12 h-12 bg-white/90 backdrop-blur-sm hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 group"
          aria-label="Facebook"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-12 h-12 bg-white/90 backdrop-blur-sm hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 rounded-lg flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 group"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-12 h-12 bg-white/90 backdrop-blur-sm hover:bg-black rounded-lg flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 group"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-12 h-12 bg-white/90 backdrop-blur-sm hover:bg-blue-700 rounded-lg flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-110 group"
          aria-label="LinkedIn"
        >
          <svg className="w-6 h-6 text-gray-700 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
