...
const PageTemplate: React.FC<PageTemplateProps> = ({
  ...
  return (
    <div className={`min-h-screen selection:bg-gray-900 selection:text-white ${isNetSuite
      ...
      <section className={`relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden ${isNetSuite || (theme === 'zoho' && isSolutionPage) ? 'text-white' : 'text-gray-900'}`}>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className={`flex flex-col lg:flex-row items-center gap-16 ${isSolutionPage ? 'lg:items-start' : ''}`}>
            ...
            >
              <span className={`inline-block text-xs font-bold tracking-[0.2em] uppercase py-2 px-4 rounded-full mb-6 ${isNetSuite
            ...
            >
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className={`group relative p-8 rounded-3xl border transition-all duration-300 ${isNetSuite
                ...
                >
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform ${isNetSuite ? 'bg-blue-500/20' : `bg-${brandColor}-50`
                    }`}>
