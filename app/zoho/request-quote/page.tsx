  ...
  const sendEmail = async (form: HTMLFormElement) => {
    ...
    fetch('/api/contact/zoho-notification', {
      ...
      body: JSON.stringify({
        ...
        subjectTitle: 'Zoho Request Quote Form Enquiry'
      })
    }).catch(() => { });
  };
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 w-full py-20 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-stretch">
            ...
            >
              ...
              {/* Scope & Quotation Process Cards */}
              <div className="grid grid-cols-2 gap-4">
                {[
                  {
                    step: "01",
                    title: "Scope Analysis",
                    desc: "Comprehensive evaluation of your required Zoho modules & workflow logic"
                  },
                  {
                    step: "02",
                    title: "Licensing Strategy",
                    desc: "Optimized user licensing structure (Zoho One vs. Standalone) for cost efficiency"
                  },
                  {
                    step: "03",
                    title: "Implementation SOW",
                    desc: "Itemized scope of work covering configuration, migration & API integrations"
                  },
                  {
                    step: "04",
                    title: "Post-Go-Live Support",
                    desc: "Flexible SLA packages for continuous user training, maintenance & upgrades"
                  }
                ].map((item, i) => (
                  <motion.div
                    key={i}
                ...
                <div className="relative z-10 pt-1">
                  ...
                  {submitted ? (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-500 max-w-xs">Thank you for reaching out. Our certified Zoho experts will send your customized quote within 24 hours.</p>
                    </motion.div>
                  ) : (
                    <form
