...
export default function LifeAtAGSuite() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-blue-600 selection:text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-24 px-6 lg:px-12 bg-gradient-to-br from-[#000814] via-[#000d2e] to-[#001a4d]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Architecting scalable cloud solutions today to empower your business tomorrow. We believe in innovation, collaboration, and driving real impact.
            </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-3xl font-medium text-gray-900">200+</h4>
                  <p className="text-[12px] text-gray-500 font-medium uppercase tracking-wider">Cloud Solutions</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      {/* ─────────────────────────────────────────────────────────
          TEAM CARD SECTION
      ────────────────────────────────────────────────────────── */}
      <section className="relative min-h-[90vh] md:min-h-screen flex flex-col justify-center overflow-hidden p-4 md:p-6 lg:p-8">
              ...
              >
                ...
                <div className="px-2 flex-grow flex flex-col pt-2">
                  ...
                  <div className="flex items-center justify-between mb-1">
                    <h3 className="text-xl md:text-2xl font-semimedium bg-gradient-to-r from-[#001535] to-[#004e9a] bg-clip-text text-transparent group-hover:from-white group-hover:to-white transition-all duration-500">
                      {leader.name}
                    </h3>
                    <a
                  ...
                  <div className="mb-2 flex-grow">
                    <span className="block text-sm font-semimedium bg-gradient-to-r from-[#001535] to-[#004e9a] bg-clip-text text-transparent group-hover:from-cyan-300 group-hover:to-cyan-300 transition-all duration-500 mb-3 border-b border-gray-300 group-hover:border-blue-400/30 pb-3 w-max pr-6">
                      {leader.title}
                    </span>
