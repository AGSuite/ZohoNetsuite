...
export const navItemsZoho: NavSection[] = [
    ...
    // ---------------- CONTACT ----------------
    {
        title: "Contact",
        children: [
            { label: 'Careers', href: '/zoho/careers', description: 'Join our growing team.', icon: Briefcase },
            // { label: 'Support', href: '/zoho/support', description: 'Get expert help.', icon: Headset },
            { label: 'Request Quote', href: '/zoho/request-quote', description: 'Get project pricing.', icon: FileText },
