        ...
        <div className="fixed left-0 top-[65%] -translate-y-1/2 z-[100] hidden lg:flex flex-col gap-1.5">
            {socialLinks.map((social) => (
                <motion.a
                    ...
                    className="group relative flex items-center h-10 outline-none"
                    initial="rest"
                    whileHover="hover"
                    animate="rest"
                >
                    ...
                    <div className="relative w-10 h-10 flex items-center justify-center text-white z-10 transition-all duration-300 group-hover:scale-110">
                        {social.icon}
                    </div>
                    ...
                    <motion.span
                        ...
                        className="relative z-10 pr-5 pl-1 font-bold text-white text-xs tracking-wide pointer-events-none whitespace-nowrap"
                    >
                        {social.name}
                    </motion.span>
