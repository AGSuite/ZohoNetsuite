...
export default function IndiaLocalizationPage() {
  ...
  const stats = [
    ...
    { label: 'Reporting Speed', value: 50, suffix: '%', icon: Zap },
  ...
  const pricingPlans = [
    { name: "Starter", description: "Small Business", price: "Contact Us", features: ["GST Calculation", "TDS Management", "Basic Reporting", "1 GSTIN", "Email Support"] },
    { name: "Growth", description: "Mid-Market", price: "Contact Us", popular: true, features: ["Everything in Starter", "E-Invoicing", "E-Way Bill", "Up to 5 GSTINs", "Priority Support", "Banking Integration"] },
    { name: "Enterprise", description: "Large Organizations", price: "Contact Us", features: ["Everything in Growth", "Unlimited GSTINs", "Custom Reporting", "Dedicated Manager", "Payroll Integration", "Custom Workflows"] }
  ];

  const faqs = [
    { question: "Is NetSuite GST compliant?", answer: "Yes, NetSuite's India Localization SuiteApp creates a GST-compliant environment, handling tax rules, return formats, and e-invoicing requirements mandated by the government." },
    { question: "Does it support E-Invoicing?", answer: "Absolutely. The solution integrates directly with the Invoice Registration Portal (IRP) to generate IRNs and signed QR codes instantly on your invoices." },
    { question: "How does it handle TDS?", answer: "It automatically calculates TDS based on vendor sections and thresholds, deducts it from payments, and generates certificates (Form 16A) and returns." },
    { question: "Can I manage multiple branches?", answer: "Yes, NetSuite supports multi-entity and multi-location structures, allowing you to manage distinctive GSTINs for each state while maintaining a consolidated view." },
    { question: "Are tax updates included?", answer: "Yes, the localized bundle is updated regularly to reflect changes in tax rates, slabs, and statutory reporting requirements announced by the GST Council." },
    { question: "Does it support Indian Banking?", answer: "We offer integrations with major Indian banks for automated payment processing and bank statement reconciliation." }
  ];
  ...
  return (
    <div className="min-h-screen selection:bg-blue-900 selection:text-white bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-orange-900/90 via-black/80 to-transparent z-10" />
          ...
          <div className="mb-8 sm:mb-10 lg:mb-12">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-orange-600/20 backdrop-blur-md rounded-full border border-orange-500/30 mb-6"
              >
                <IndianRupee className="w-4 h-4 text-orange-400" />
                <span className="text-orange-300 font-medium text-sm">GST Ready ERP</span>
              </motion.div>
              ...
              >
                NetSuite <span className="text-orange-500">India Localization</span>
              </motion.h1>
              ...
              <motion.div
                ...
                className="h-1 bg-orange-600 mb-4 sm:mb-6"
              />
              ...
              >
                Complete compliance solution for Indian businesses. Manage GST, TDS, and statutory reporting effortlessly.
              </motion.p>
              ...
              {stats.map((stat, index) => (
                ...
                >
                  <div className="flex justify-center mb-2 sm:mb-3">
                    <div className="p-2 sm:p-3 bg-orange-600/20 rounded-xl sm:rounded-2xl group-hover:bg-orange-600/30 transition-colors duration-300">
                      <stat.icon className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-orange-400 group-hover:scale-110 transition-transform duration-300" />
                    </div>
                  </div>
                  <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-1 sm:mb-2 flex items-center justify-center gap-1">
                    ...
                    <span className="text-orange-400 text-2xl sm:text-3xl md:text-4xl">{stat.suffix}</span>
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.2 }} className="space-y-6">
              <div className="space-y-4">
                <h2 className="text-orange-600 font-bold uppercase tracking-wider text-sm">Local Compliance</h2>
                <h3 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight">Simplify Indian Taxes</h3>
              </div>
              <p className="text-lg text-gray-600 leading-relaxed">Running a business in India comes with unique financial and statutory requirements. NetSuite India Localization brings global ERP power with local compliance.</p>
              <p className="text-lg text-gray-600 leading-relaxed">From GST filing to TDS deductions and financial reporting, everything is built-in and automated to keep your business compliant and audit-ready.</p>
              <div className="pt-4">
                <Link href="/netsuite/contact" className="inline-flex items-center gap-2 text-orange-600 font-bold hover:gap-4 transition-all uppercase tracking-widest text-sm">
      ...
      <section className="py-24 bg-[#000b21] overflow-hidden relative">
        ...
        <div className="absolute bottom-0 left-0 w-[500px] h-[600px] bg-green-600/10 rounded-full blur-[120px]" />
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            <span className="bg-orange-600/20 text-orange-300 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest">Advantages</span>
            <h3 className="text-4xl md:text-5xl font-black text-white mt-6">Why Localize?</h3>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto text-lg">Seamless operations in the Indian market</p>
          </motion.div>
            ...
            <div className="space-y-4">
              {benefits.map((item, index) => (
                <motion.div key={index} initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.1 }}
                  onClick={() => setActiveBenefit(index)} className={`p-6 rounded-2xl cursor-pointer transition-all duration-300 border ${activeBenefit === index ? 'bg-white/10 border-orange-400/50 shadow-lg backdrop-blur-sm' : 'bg-white/5 border-white/10 hover:bg-white/10'}`}>
                  <div className="flex items-center gap-4">
                    <div className={`p-2 rounded-lg transition-colors ${activeBenefit === index ? 'bg-orange-600 text-white shadow-lg shadow-orange-600/50' : 'bg-white/10 text-orange-300'}`}>
                  ...
                  <AnimatePresence>
                    {activeBenefit === index && (
                      <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden">
                        <p className="text-orange-100 mt-4 leading-relaxed pl-12">{item.description}</p>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </motion.div>
      ...
      <section className="py-24 bg-gradient-to-b from-[#000b21] via-[#000b21] to-[#0a0a0a] overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            <span className="bg-orange-600/20 text-orange-300 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest">Challenges</span>
            <h3 className="text-4xl md:text-5xl font-black text-white mt-6">Compliance Hurdles</h3>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto text-lg">Overcome regulatory complexity</p>
          </motion.div>
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            <div className="space-y-4 flex flex-col justify-center">
              {challenges.map((item, index) => (
                <motion.div key={index} initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: index * 0.1 }}
                  onClick={() => setActiveChallenge(index)} className={`p-6 rounded-2xl cursor-pointer transition-all duration-300 border ${activeChallenge === index ? 'bg-white/10 border-orange-400/50 shadow-lg backdrop-blur-sm' : 'bg-white/5 border-white/10 hover:bg-white/10'}`}>
                  <div className="flex items-center gap-4">
                    <div className={`p-2 rounded-lg transition-colors ${activeChallenge === index ? 'bg-orange-600 text-white shadow-lg shadow-orange-600/50' : 'bg-white/10 text-orange-300'}`}>
                      <CheckCircle2 size={20} />
                    </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 via-orange-50/20 to-green-50/20">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            <span className="bg-orange-600/10 text-orange-600 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest">Pricing</span>
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mt-6 mb-4">Choose Your Plan</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">Localized solutions for any scale</p>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }}
                className={`bg-white rounded-2xl p-8 border-2 ${plan.popular ? 'border-orange-600 shadow-2xl shadow-orange-200 relative' : 'border-gray-200'}`}>
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <span className="bg-orange-600 text-white px-4 py-1 rounded-full text-xs font-bold uppercase">Most Popular</span>
                  </div>
                )}
                ...
                <Link href="/netsuite/contact" className={`block text-center px-6 py-3 rounded-xl font-bold transition ${plan.popular ? 'bg-orange-600 text-white hover:bg-orange-700' : 'bg-gray-100 text-gray-900 hover:bg-gray-200'}`}>
                  Get Started
                </Link>
              </motion.div>
            ))}
      ...
      {/* FAQ Section */}
      <section className="py-24 bg-gradient-to-br from-blue-50 via-gray-50 to-orange-50 relative overflow-hidden">
        {/* Background Gradients */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-orange-600/20 rounded-full blur-[120px] -z-10" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-green-600/20 rounded-full blur-[120px] -z-10" />
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          >
            <span className="bg-orange-600/10 text-orange-700 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest">
              FAQ
            </span>
            ...
            <p className="text-slate-600 text-lg">
              Compliance and capabilities in detail
            </p>
          </motion.div>
            ...
            {faqs.map((faq, index) => (
              <motion.div
                ...
                className={`group rounded-2xl border transition-all duration-300 ${openFAQ === index
                  ? 'bg-white border-orange-500/30 shadow-2xl shadow-orange-900/10 scale-[1.02] z-10'
                  : 'bg-white/80 border-white/50 shadow-sm hover:shadow-xl hover:shadow-orange-900/5 hover:border-orange-200 hover:-translate-y-1 hover:bg-white'
                  }`}
              >
                <button
                ...
                >
                  <span className={`text-left font-bold text-lg transition-colors ${openFAQ === index ? 'text-orange-700' : 'text-slate-900 group-hover:text-orange-600'
                    }`}>
                    {faq.question}
                  </span>
                  <div className={`p-2 rounded-full transition-all duration-300 flex-shrink-0 ml-4 ${openFAQ === index
                    ? 'bg-gradient-to-r from-orange-600 to-red-600 text-white rotate-180 shadow-lg shadow-orange-500/30'
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative rounded-[3rem] overflow-hidden border border-gray-200">
            ...
            <div className="relative z-10 p-12 lg:p-24">
              <div className="max-w-2xl">
                <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">Ready for India?</h2>
                <p className="text-xl text-gray-300 mb-8">Equip your business with the best localized ERP for India.</p>
                <Link href="/netsuite/contact" className="inline-flex items-center gap-2 px-10 py-4 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-2xl transition shadow-xl">
