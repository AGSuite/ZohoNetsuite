...
import {
  BarChart3, TrendingUp, Eye, Brain, Zap, Target, CheckCircle2, ArrowRight, PieChart,
  LineChart, Activity, Check, ChevronDown, Database, Gauge, Share2, Code, ShieldCheck,
...
export default function NetSuiteBIPage() {
  ...
  const benefits = [
    { title: "Real-Time Insights", description: "Monitor KPI's and metrics in real-time with role-based dashboards.", image: "/images/lap/lap2.webp" },
    { title: "Self-Service Analytics", description: "Empower users to create their own reports and visualizations without IT help.", image: "/images/lap/lap3.webp" },
    { title: "Predictive Intelligence", description: "Leverage AI and machine learning to forecast trends and opportunities.", image: "/images/people/laptopmen1.jpg" },
    { title: "Mobile Access", description: "Stay connected to your business performance from anywhere, on any device.", image: "/images/lap/lap5.webp" }
  ];

  const challenges = [
    { title: "Data Silos", description: "Eliminate fragmented data and get a single version of the truth.", image: "/images/lap/lap1.webp" },
    { title: "Slow Reporting", description: "Stop waiting days for manual reports and get answers instantly.", image: "/images/people/man.webp" },
    { title: "Static Data", description: "Move beyond static spreadsheets to dynamic, interactive analytics.", image: "/images/lap/lap4.webp" },
    { title: "Complexity", description: "Simplify complex data into clear, actionable visual insights.", image: "/images/people/laptopgirl3.webp" }
  ];

  const biModules = [
    { title: "Real-Time Dashboards", description: "Customizable dashboards with live data updates for instant insights.", icon: Gauge },
    { title: "Advanced Reporting", description: "Drag-and-drop report builder with 200+ pre-built templates.", icon: BarChart3 },
    { title: "SuiteAnalytics", description: "Explore and analyze data with pivot tables and visual analytics.", icon: PieChart },
    { title: "KPI Tracking", description: "Monitor key performance indicators with automated alerts.", icon: Target },
    { title: "Predictive Analytics", description: "AI-powered forecasting and trend analysis for proactive decisions.", icon: Brain },
    { title: "Mobile Analytics", description: "Access reports and dashboards on any device, anywhere.", icon: Eye },
  ];
  ...
  const pricingPlans = [
    { name: "Essential", description: "For basic reporting needs", price: "Contact Us", features: ["Standard Dashboards", "Basic Reports", "Export to Excel", "Up to 10 Users", "Email Support"] },
    { name: "Professional", description: "For advanced analytics", price: "Contact Us", popular: true, features: ["Everything in Essential", "SuiteAnalytics", "Custom Dashboards", "Unlimited Users", "24/7 Support", "API Access"] },
    { name: "Enterprise", description: "For data-driven organizations", price: "Contact Us", features: ["Everything in Professional", "Predictive Analytics", "Advanced Visualizations", "Dedicated Manager", "Priority Support", "Custom SLA"] }
  ];

  const faqs = [
    { question: "What is NetSuite Business Intelligence?", answer: "NetSuite BI provides comprehensive analytics and reporting capabilities built directly into your NetSuite platform, enabling real-time insights into business performance without the need for separate BI tools." },
    { question: "What is SuiteAnalytics?", answer: "SuiteAnalytics is NetSuite's advanced analytics workbench that allows you to explore data, create custom reports, build pivot tables, and visualize insights using an intuitive drag-and-drop interface." },
    { question: "Can I create custom dashboards?", answer: "Yes! NetSuite allows you to create fully customizable dashboards with your choice of KPIs, charts, reports, and reminders. You can create role-specific dashboards for different users." },
    { question: "How many pre-built reports are available?", answer: "NetSuite includes over 200 pre-built reports across all modules including financial reports, sales reports, inventory reports, and operational reports that you can use immediately." },
    { question: "Does NetSuite support mobile analytics?", answer: "Absolutely. NetSuite's mobile app provides full access to dashboards, reports, and analytics on iOS and Android devices, ensuring you stay informed on the go." },
    { question: "Can I schedule automated reports?", answer: "Yes, you can schedule reports to run automatically and be delivered via email to stakeholders on a daily, weekly, or monthly basis." }
  ];
        ...
        <div className="relative z-20 flex-1 flex flex-col justify-end max-w-7xl mx-auto px-4 sm:px-6 w-full pt-32 sm:pt-40 md:pt-48 pb-12 sm:pb-16">
          <div className="mb-8 sm:mb-10 lg:mb-12">
            ...
            >
              ...
              >
                NetSuite <span className="text-blue-600">Business Intelligence</span>
              </motion.h1>
              ...
              >
                Real-time insights and analytics built into your ERP platform.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="relative min-h-[400px] lg:min-h-[500px] rounded-3xl overflow-hidden shadow-2xl border border-gray-100">
              <Image src="/images/lap/group1.webp" alt="What is NetSuite BI" fill className="object-cover" />
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.2 }} className="space-y-6">
              <div className="space-y-4">
                <h2 className="text-blue-600 font-bold uppercase tracking-wider text-sm">About NetSuite BI</h2>
                <h3 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight">What is NetSuite BI?</h3>
              </div>
              <p className="text-lg text-gray-600 leading-relaxed">NetSuite Business Intelligence provides powerful analytics and reporting capabilities built directly into your ERP system.</p>
              <p className="text-lg text-gray-600 leading-relaxed">Get real-time insights with customizable dashboards, advanced reporting, and AI-powered analytics to make data-driven decisions faster.</p>
              <div className="pt-4">
      ...
      <section id="features" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">BI Capabilities</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">Comprehensive analytics for informed decision-making</p>
          </motion.div>
      ...
      <section className="py-16 bg-linear-to-br from-indigo-50/40 via-white to-blue-50/30 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-10 flex flex-col items-center gap-5">
          ...
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }} className="text-gray-700 text-lg max-w-2xl text-center">
            Expert services to help you make sense of your data and insights
          </motion.p>
      ...
      <section className="py-24 bg-[#000b21] overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-white mt-6">Why Choose NetSuite BI?</h3>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto text-lg">Turn data into competitive advantage</p>
          </motion.div>
      ...
      <section className="py-24 bg-gradient-to-b from-[#000b21] via-[#000b21] to-[#0a0a0a] overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-white mt-6">Common Data Challenges</h3>
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto text-lg">Solve your analytics problems with NetSuite</p>
          </motion.div>
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 via-blue-50/20 to-indigo-50/30">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">Analytics solutions for every business</p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-slate-600 text-lg">
              Everything you need to know about NetSuite BI
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative rounded-[3rem] overflow-hidden border border-gray-200">
            <Image src="/images/people/group5.webp" alt="Get Started with NetSuite BI" fill className="object-cover" />
            <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/80 to-transparent" />
            <div className="relative z-10 p-12 lg:p-24">
              <div className="max-w-2xl">
                <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 leading-tight">Ready for Data-Driven Decisions?</h2>
                <p className="text-xl text-gray-300 mb-8">Discover how NetSuite BI can transform your analytics.</p>
                <Link href="/netsuite/contact" className="inline-flex items-center gap-2 px-10 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl transition shadow-xl">
                  See BI in Action <ArrowRight size={20} />
                </Link>
              </div>
            </div>
          </motion.div>
