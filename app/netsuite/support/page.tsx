...
export default function SupportPageLevel() {
                    ...
                    <div className="grid lg:grid-cols-2 gap-14 xl:gap-20 items-start">
                        ...
                        >
                            ...
                            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 bg-white backdrop-blur-md w-fit shadow-lg shadow-blue-500/10">
                                ...
                                <span className="text-blue-900 text-xs font-medium tracking-widest uppercase">24/7 Global Support</span>
                            </div>

                            <h1 className="text-4xl sm:text-5xl xl:text-5xl font-medium bg-clip-text text-transparent bg-gradient-to-r from-blue-50 via-indigo-50 to-cyan-50 leading-[1.1] tracking-tight">
                                Bulletproof Continuity.<br />
                            ...
                            <div className="space-y-4">
                                <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
                                    Experience seamless business continuity with AGSuite. Our certified mission-control team is available 24/7 to resolve technical blocks and optimize system performance.
                                </p>
                            </div>
                                ...
                                {[
                                    {
                                        ...
                                        desc: "For technical queries and tickets. We prioritize resolution speed and clarity.",
                                        color: "blue"
                                    },
                                    {
                                        icon: Phone,
                                        ...
                                        desc: "Urgent assistance during business hours. Connect directly with a lead consultant.",
                                        color: "indigo"
                                    },
                                    {
                                        icon: Clock,
                                        ...
                                        desc: "We prioritize your business continuity. Every ticket is handled with high-urgency protocols.",
                                        color: "cyan"
                                    },
                                    {
                                        icon: HelpCircle,
                                        title: "Support Portal",
                                        contact: "Dedicated Client Desk",
                                        desc: "Real-time ticket tracking and priority queuing for all our implementation clients.",
                                        color: "blue"
                                    }
                                ].map((item, i) => (
                                    <motion.div
                                    ...
                                    >
                                        ...
                                        <h4 className="bg-clip-text text-transparent bg-gradient-to-r from-blue-900 to-black font-medium text-lg mb-1 leading-tight">{item.title}</h4>
                                        <p className="text-blue-600 text-sm font-medium mb-2">{item.contact}</p>
                            ...
                            <div className="relative bg-white rounded-3xl shadow-[0_32px_80px_rgba(0,0,0,0.5)] overflow-hidden">
                                ...
                                <div className="relative z-10 p-8 lg:p-10">
                                    <div className="mb-8 border-b border-gray-100 pb-6">
                                        <h2 className="text-2xl bg-clip-text text-transparent bg-gradient-to-r from-blue-900 via-indigo-900 to-cyan-900 sm:text-3xl font-medium mb-2">Open a Support Ticket</h2>
                                        <p className="text-gray-500 text-base">Detail your request — our technical desk will connect within 24 hours.</p>
                                    </div>
                                    ...
                                    {submitted ? (
                                        ...
                                        >
                                            ...
                                            <p className="text-gray-500 max-w-xs">Your request has been queued. A support consultant will reach out shortly.</p>
                                        </motion.div>
                                    ) : (
                                        <form onSubmit={handleSubmit} className="space-y-5">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                                ...
                                                <div>
                                                    <label className="block text-gray-700 text-xs font-semimedium uppercase tracking-wider mb-2">
                                                        Support Category <span className="text-blue-600">*</span>
                                                    </label>
                                                    <select
                                                        required
                                                    ...
                                                    >
                                                        ...
                                                        <option value="Customization Support">Customization Support</option>
