...
export default function ZohoFreeConsultationPage() {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-blue-900 selection:text-white">
            ...
            <div className="flex flex-col justify-center gap-5 pt-2">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="relative group p-4 sm:p-5 rounded-2xl bg-gradient-to-br from-white via-white/95 to-blue-50/90 border border-blue-100/60 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 overflow-hidden text-left"
                  >
                    <div className="relative z-10 flex flex-col items-start">
                      <div className="mb-2.5 px-2.5 py-1 rounded-lg bg-blue-50 text-blue-600 font-extrabold text-xs group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300 shadow-xs">
                        {item.step}
                      </div>
                      <h4 className="text-sm sm:text-base font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#000d2e] via-blue-900 to-black tracking-tight leading-tight mb-1">
                        {item.title}
                      </h4>
      ...
      {/* ── Scripts ───────────────────────────────────────────────────────────── */}
      <Script src="https://www.google.com/recaptcha/api.js?onload=onRecaptchaLoadZohoConsult&render=explicit" async defer strategy="lazyOnload" />
