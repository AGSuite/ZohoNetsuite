...
export default function ThankYouPage() {
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#f0f4f8]">

      {/* === LIGHT GRADIENT BACKGROUND === */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#e8f0fe] via-[#f5f0ff] to-[#e0f7fa]" />

      {/* Soft radial glows */}
      <div
        className="absolute -top-20 -right-20 w-[480px] h-[480px] rounded-full opacity-25 pointer-events-none"
        style={{ background: 'radial-gradient(circle, #818cf8 0%, transparent 70%)' }}
      />
      <div
        className="absolute -bottom-24 -left-16 w-[420px] h-[420px] rounded-full opacity-20 pointer-events-none"
      ...
      {/* === CORNER DECORATIVE SHAPES (like reference) === */}
      {/* Top-left triangle */}
      <div
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(315deg, #7dd3fc 0%, #a5b4fc 100%)',
          clipPath: 'polygon(100% 0, 100% 100%, 0 100%)',
          opacity: 0.5,
        }}
      />
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(225deg, #fbcfe8 0%, #f0abfc 100%)',
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(45deg, #bfdbfe 0%, #a5f3fc 100%)',
