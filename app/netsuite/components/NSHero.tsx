    ...
    <div id="hero" className="relative w-full font-dm-sans">
      ...
      <section className="relative w-full h-[100dvh] min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          {/* Mobile background (portrait): solid blue gradient fallback + mobile-optimised image */}
          <picture>
            <source
              media="(max-width: 1023px)"
              srcSet="/images/Background/herobluebg_mob.webp"
              type="image/webp"
            />
            <source
              media="(min-width: 1024px)"
              srcSet="/images/Background/herobluebg.webp"
              type="image/webp"
            />
            <img
        ...
        {/* Navbar offset spacer — pushes content below the fixed navbar */}
        ...
        <div className="relative z-10 w-full px-5 sm:px-8 lg:px-12 flex flex-col items-start justify-center h-full pt-[72px] sm:pt-[80px] pb-12">
          <div className="max-w-2xl">
            {/* Badge */}
            <span className="inline-flex items-center gap-1.5 mb-4 px-3 py-1 rounded-full text-xs font-semibold tracking-wide bg-blue-600/15 text-blue-800 border border-blue-300/60 backdrop-blur-sm">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-600 animate-pulse" />
              Oracle NetSuite Solution Provider Partner
            </span>

            {/* Headline */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight tracking-tight bg-gradient-to-r from-blue-950 via-blue-800 to-blue-700 bg-clip-text text-transparent pb-1">
            ...
            <div className="mt-6 relative inline-flex group">
              <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-[#44BCFF] via-[#FF44EC] to-[#FF675E] opacity-70 blur-lg group-hover:opacity-100 transition duration-500" />
              <Link
                href="#contact-form"
        ...
        {/* Render the full interactive slider once mounted (replaces SSR placeholder) */}
        {isMounted && (
