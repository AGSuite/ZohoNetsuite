  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none -z-0 overflow-hidden">
        ...
        >
          <defs>
            <pattern id="crm-clients-dotted-grid" width="44" height="44" patternUnits="userSpaceOnUse">
              <path
                d="M 44 0 L 0 0 0 44"
                fill="none"
                stroke="#2563eb"
          ...
          <rect width="100%" height="100%" fill="url(#crm-clients-dotted-grid)" />
        </svg>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-7 text-center">
        ...
        >
          High-growth organizations trust AGSuite for world-class CRM implementations, 
          sales pipeline automation, AI-driven forecasting, and customer retention.
        </motion.p>
      </div>
