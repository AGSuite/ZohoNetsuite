...
export default function IndiaLocalizationPage() {
  ...
  const modules = [
    { title: "GST Management", description: "End-to-end GST engine for tax calculation, return preparation, and seamless reconciliation across entities.", image: "/images/lap/lap1.webp", color: "#e07820", rgb: "224,120,32" },
    { title: "E-Invoicing (IRP)", description: "Direct integration with the Invoice Registration Portal for real-time IRN generation and signed QR codes.", image: "/images/lap/lap2.webp", color: "#1e8a6e", rgb: "30,138,110" },
    { title: "TDS Management", description: "Automated tax deduction at source with Form 16A generation, threshold tracking, and audit reports.", image: "/images/lap/lap3.webp", color: "#1a4fa8", rgb: "26,79,168" },
    { title: "TCS Compliance", description: "Tax collected at source on applicable sales transactions with full statutory compliance and reporting.", image: "/images/lap/lap4.webp", color: "#7b3a8a", rgb: "123,58,138" },
    { title: "E-Way Bill", description: "Generate E-Way bills automatically from NetSuite invoices and delivery orders — no manual data entry.", image: "/images/lap/lap5.webp", color: "#8a2a20", rgb: "138,42,32" },
    { title: "GSTR Filing", description: "Automated GSTR-1, GSTR-3B, and GSTR-9 preparation with built-in validation and reconciliation.", image: "/images/people/laptopgirl1.webp", color: "#4a3a8a", rgb: "74,58,138" },
    { title: "Statutory Reporting", description: "Local tax reports and financial statements formatted per Indian statutory requirements.", image: "/images/lap/lap7_11zon.webp", color: "#1a6080", rgb: "26,96,128" },
    { title: "Multi-GSTIN", description: "Manage multiple GSTINs and state registrations within a single NetSuite account seamlessly.", image: "/images/people/laptopmen2.webp", color: "#6a2575", rgb: "106,37,117" },
    { title: "Banking Integration", description: "Automated payments and bank statement reconciliation with major Indian banks.", image: "/images/people/threeteam.webp", color: "#154e8a", rgb: "21,78,138" },
    { title: "Payroll Compliance", description: "PF, ESI, and professional tax calculations fully aligned with Indian labour law requirements.", image: "/images/lap/lap8_11zon.webp", color: "#1a6545", rgb: "26,101,69" },
    { title: "Audit Trail", description: "Complete, traceable financial records ensuring you are audit-ready at every point in time.", image: "/images/people/fourteam.webp", color: "#8a5010", rgb: "138,80,16" },
    { title: "GSTIN Validation", description: "Real-time vendor and customer GSTIN validation to prevent errors before they reach your returns.", image: "/images/people/laptopgirl.webp", color: "#0f4e8a", rgb: "15,78,138" },
  ];

  const benefits = [
    { title: "Full GST Compliance", description: "NetSuite's India Localization automates the entire GST lifecycle — from tax calculation on transactions to GSTR return preparation and e-invoicing — keeping you always compliant.", image: "/images/people/laptopmen2.webp", points: ["Auto GST calculation on all transactions", "GSTR-1, GSTR-3B, and GSTR-9 ready", "E-invoicing with IRP integration", "Real-time GSTIN validation"] },
    { title: "Effortless TDS & TCS", description: "Automate Tax Deducted at Source and Tax Collected at Source based on vendor sections, payment thresholds, and transaction types — with zero manual calculation required.", image: "/images/lap/lap4.webp", points: ["Auto TDS deduction on payments", "Form 16A and Form 27 generation", "Lower deduction certificate support", "Full tax audit trail and reports"] },
    { title: "Instant E-Way Bills", description: "Generate E-Way bills directly from NetSuite invoices and delivery orders, eliminating manual data entry and reducing compliance delays at logistics checkpoints.", image: "/images/lap/lap5.webp", points: ["Auto E-Way bill from invoice", "Bulk E-Way bill generation", "Sync with GSTIN e-way portal", "Expiry alerts and extensions"] },
    { title: "Multi-Location & Multi-GSTIN", description: "Manage businesses with multiple branches, states, and GSTINs from a single NetSuite account — with entity-level separation and fully consolidated group reporting.", image: "/images/people/laptopgirl1.webp", points: ["Multiple GSTINs in one account", "State-wise tax reporting", "Inter-company and branch transfers", "Consolidated India-wide view"] },
    { title: "Automated Statutory Reporting", description: "Generate all required statutory reports — from profit & loss in Indian formats to tax audit schedules — directly from NetSuite with no manual data extraction.", image: "/images/lap/lap2.webp", points: ["Schedule III financial statements", "Tax audit annexure reports", "Form 3CD and 3CEB support", "Director and board reporting formats"] },
    { title: "Always Updated for Compliance", description: "NetSuite India Localization is updated whenever GST Council changes rates, slabs, or filing formats — so you always remain compliant without any manual effort.", image: "/images/people/fourteam.webp", points: ["Tax rate changes applied automatically", "New filing-format updates included", "GST Council notifications tracked", "Proactive compliance alerts"] },
  ];
      ...
      <nav className="sticky top-[72px] z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-center gap-1 overflow-x-auto scrollbar-hide py-4">
            {[{ label: "What is India Localization?", href: "#what-is" }, { label: "Capabilities", href: "#modules" }, { label: "Benefits", href: "#benefits" }, { label: "Pricing", href: "#pricing" }, { label: "FAQ", href: "#faq" }].map(l => (
