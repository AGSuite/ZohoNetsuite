...
export default function IntegrationPage() {
  ...
  const stats = [
    ...
    { label: "Real-Time Data Sync", value: 100, suffix: "%", icon: Zap },
    { label: "Uptime SLA", value: 99, suffix: ".9%", icon: CheckCircle2 },
    { label: "Data Accuracy", value: 100, suffix: "%", icon: TrendingUp },
  ];
  ...
  const services = [
    {
      ...
      description:
        "Sync orders, inventory, customers, and fulfilment in real time between NetSuite and Shopify, Magento, WooCommerce, Amazon, and other platforms.",
    ...
    },
    {
      ...
      description:
        "Implement and manage enterprise middleware platforms — Celigo, Dell Boomi, MuleSoft, or Zapier — for complex multi-point data flows.",
    ...
    {
      title: "WMS & Logistics Integration",
      description:
        "Connect NetSuite with warehouse management systems, 3PLs, and shipping carriers — automating fulfilment, tracking, and inventory updates.",
    ...
    },
    {
      ...
      description:
        "Sync employee records, payroll journals, cost centres, and HR data between NetSuite and platforms like Workday, BambooHR, and ADP.",
    ...
    },
    {
      ...
      description:
        "Integrate NetSuite with Stripe, PayPal, Razorpay, Adyen, or bank gateways — automating payment capture, reconciliation, and refund processing.",
    ...
    },
    {
      ...
      description:
        "Connect NetSuite directly to bank feeds, treasury systems, and open banking APIs for automated transaction matching and cash position reporting.",
    ...
    },
    {
      ...
      description:
        "Build connections between NetSuite and SaaS platforms — Slack, Microsoft Teams, Power BI, Google Workspace, and more — for workflow and reporting automation.",
    ...
    {
      title: "Integration Monitoring & Support",
      description:
        "Proactively monitor your integration landscape with real-time error alerting, automated retry logic, and dedicated support to keep data flowing 24/7.",
  ...
  const benefits = [
    {
      title: "Real-Time, Bi-Directional Data Sync",
      description:
        "Our integrations push and pull data in real time — so your teams always work with the same live information across NetSuite and every connected platform.",
      image: "/images/lap/lap1.webp",
      points: [
    ...
    },
    {
      ...
      description:
        "Integration failures can cascade into operational chaos. We build resilient architectures with automatic retry logic, dead-letter queues, and instant alerting so issues are caught before they impact the business.",
      image: "/images/people/laptopgirl.webp",
      points: [
    ...
    },
    {
      ...
      description:
        "Whether you're processing 100 transactions per day or 1 million, our integration framework scales horizontally — handling peak loads without degradation.",
      image: "/images/lap/lap3.webp",
      points: [
    ...
    },
    {
      ...
      description:
        "Every integration is built with security at its core — OAuth 2.0, encrypted data in transit and at rest, IP-restricted access, and full audit logs for every data exchange.",
      image: "/images/people/laptopmen2.webp",
      points: [
    ...
    },
    {
      ...
      description:
        "Remove data silos by designating NetSuite as the master record — with clear data ownership rules, deduplication logic, and conflict resolution strategies built in.",
      image: "/images/lap/lap2.webp",
      points: [
    ...
    {
      title: "Transparent Integration Monitoring",
      description:
        "Our clients get a real-time integration monitoring dashboard — showing sync status, error rates, and throughput across every connected system at a glance.",
      image: "/images/people/fourteam.webp",
      points: [
    ...
    <div className="min-h-screen selection:bg-blue-900 selection:text-white bg-white">
          ...
          >
            ...
            >
              ...
              >
                ...
                e-commerce platforms, CRMs, WMS, payment gateways, and
                third-party apps — with real-time, resilient, and secure data
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs mt-0.5 leading-snug">
                      Zero silos · Resilient architecture · 99.9% uptime
                    </p>
                  </div>
                </motion.div>
      ...
      <nav className="sticky top-[72px] z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-center gap-1 overflow-x-auto scrollbar-hide py-4">
            {[
              { label: "What is NetSuite Integration?", href: "#what-is" },
          ...
          <div className="grid lg:grid-cols-2 gap-6 items-stretch">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                NetSuite Integration connects your ERP to the rest of your
                business technology stack — ensuring orders, inventory,
                customers, and financial data flow automatically and accurately
                between every system. No more manual exports, CSV uploads, or
                data reconciliation.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
      ...
      >
        <div className="max-w-7xl mx-auto px-10 flex flex-col items-center gap-5">
          ...
          >
            12 specialised integration services covering every system in your
            business ecosystem
          </motion.p>
      ...
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <style>{`
            ...
            .star-integ { position:absolute; border-radius:9999px; background:white; animation: twinkle var(--tw-dur, 3s) ease-in-out infinite var(--tw-delay, 0s), drift calc(var(--tw-dur, 3s) * 2) ease-in-out infinite var(--tw-delay, 0s); }
          `}</style>
          {[
            ...
            <div className="grid lg:grid-cols-[3fr_2fr] gap-0 items-stretch">
              <div className="py-12 px-10 lg:px-16 flex flex-col justify-center">
                ...
                <p className="text-white/75 text-base leading-relaxed mb-8">
                  Integration pricing is scoped by the number of systems to
                  connect, data volume, sync frequency, and error-handling
                  complexity. Simple API connectors can be delivered as
                  fixed-fee projects, while enterprise middleware orchestrations
                  are governed by a phased SOW. Every engagement includes full
                  documentation, monitoring setup, and a defined support model.
                </p>
                <div>
                  <a
                    href="#contact-form"
