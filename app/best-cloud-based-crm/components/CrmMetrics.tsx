...
const stats = [
  ...
  { value: "50+", label: "CRM & ERP Experts" },
...
export default function CrmMetrics() {
  ...
  const headlineText = "Trusted Cloud CRM Implementation Partner with";
  const highlightText = "15+ years of enterprise CRM excellence";
  ...
  return (
    <section
      ref={containerRef}
      id="platform"
      className="relative py-24 overflow-hidden font-['DM_Sans',sans-serif] bg-gradient-to-b from-white via-slate-50 to-blue-50/50 text-slate-900 scroll-mt-20"
    >
      ...
      >
        <defs>
          <pattern id="crm-metrics-dotted-grid" width="44" height="44" patternUnits="userSpaceOnUse">
            <path
              d="M 44 0 L 0 0 0 44"
              fill="none"
              stroke="#2563eb"
        ...
        <rect width="100%" height="100%" fill="url(#crm-metrics-dotted-grid)" />
      </svg>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white/90 border border-blue-200/80 text-blue-700 text-xs sm:text-sm font-bold uppercase tracking-wider mb-6 shadow-sm backdrop-blur-xs"
          >
            <Sparkles className="w-4 h-4 text-blue-600 animate-pulse" />
            <span>Enterprise Cloud CRM Architecture</span>
            <ShieldCheck className="w-4 h-4 text-emerald-600 ml-0.5" />
          </motion.div>

          {/* Headline with Word-by-Word Animation */}
          <motion.h2
            ref={headlineRef}
            className="text-3xl sm:text-4xl md:text-5xl lg:text-[46px] font-extrabold text-slate-900 tracking-tight leading-[1.2] mb-6 max-w-4xl mx-auto"
          >
            ...
            <motion.span
              ...
              className="inline-block mt-2 sm:mt-1"
            >
          ...
          >
            Empowering 250+ fast-scaling businesses and enterprises with intelligent sales pipeline automation, 
            AI-driven customer analytics, and dedicated cloud CRM implementation services.
          </motion.p>
          ...
          {/* 3D Tilt Perspective Zoho CRM Dashboard Frame */}
                ...
                <div className="flex items-center justify-between px-5 py-3.5 bg-slate-900 text-white border-b border-slate-800">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-slate-300 ml-4 font-mono tracking-wide hidden sm:inline-block">
                      AGSuite — Official Zoho CRM Sales & Pipeline Intelligence Dashboard
                    </span>
                  </div>
