...
import {
  BarChart3, TrendingUp, Eye, Brain, Zap, Target,
  CheckCircle2, ArrowRight, PieChart, LineChart, Activity,
  Check, ChevronDown, Database, Gauge
} from 'lucide-react';
...
export default function NetSuiteBIPage() {
  ...
  const benefits = [
    { title: "Real-Time Insights", description: "Monitor KPI's and metrics in real-time with role-based dashboards.", image: "/images/Dashboard/NetsuiteDashboard.webp" },
    ...
    { title: "Predictive Intelligence", description: "Leverage AI and machine learning to forecast trends and opportunities.", image: "/images/Dashboard/graph2.webp" },
  ...
  const challenges = [
    ...
    { title: "Static Data", description: "Move beyond static spreadsheets to dynamic, interactive analytics.", image: "/images/aboutus/mission.webp" },
    { title: "Complexity", description: "Simplify complex data into clear, actionable visual insights.", image: "/images/aboutus/CTA1.webp" }
  ];
