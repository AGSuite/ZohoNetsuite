        ...
        <footer className="bg-gradient-to-b from-slate-900 to-black text-white">
            <div className="max-w-7xl mx-auto px-6 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="mt-6">
                            <div className="flex gap-3">
                                <a href="https://www.facebook.com/AGSuiteTech" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-slate-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors" aria-label="Facebook">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                    </svg>
                                </a>
                                <a href="https://www.instagram.com/agsuitetech/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-slate-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 rounded-lg flex items-center justify-center transition-colors" aria-label="Instagram">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="https://x.com/agsuite" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-slate-800 hover:bg-black rounded-lg flex items-center justify-center transition-colors" aria-label="Twitter">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                    </svg>
                                </a>
                                <a href="https://www.linkedin.com/company/agsuitetech/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-slate-800 hover:bg-blue-700 rounded-lg flex items-center justify-center transition-colors" aria-label="LinkedIn">
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Industries */}
                    <div>
                        <h4 className="text-lg font-bold mb-4 text-orange-400">Industries</h4>
                        <ul className="space-y-3">
                            <li>
                                <Link href="/zoho/software-and-technology" className="text-gray-400 hover:text-white transition-colors text-sm">
                                    Software & Technology
                                </Link>
                            </li>
                            <li>
                                <Link href="/zoho/it-and-professional-services" className="text-gray-400 hover:text-white transition-colors text-sm">
                                    IT & Professional Services
                                </Link>
                            </li>
                            <li>
                                <Link href="/zoho/wholesale-distribution" className="text-gray-400 hover:text-white transition-colors text-sm">
                                    Wholesale Distribution
                                </Link>
                            </li>
                            <li>
                                <Link href="/zoho/retail-and-e-commerce" className="text-gray-400 hover:text-white transition-colors text-sm">
                                    Retail & E-Commerce
                                </Link>
                            </li>
                            <li>
                                <Link href="/zoho/manufacturing" className="text-gray-400 hover:text-white transition-colors text-sm">
                                    Manufacturing
                                </Link>
                            </li>
                            <li>
                                <Link href="/zoho/advertising-and-digital-marketing-agencies" className="text-gray-400 hover:text-white transition-colors text-sm">
