...
import {
  ShoppingBag, TrendingUp, Globe, CreditCard, Truck, Users,
  CheckCircle2, ArrowRight, BarChart3, Smartphone, Monitor,
  Check, ChevronDown, Package, Zap, Search, ShieldCheck
} from 'lucide-react';
...
export default function NetSuiteEcommercePage() {
  ...
  const benefits = [
    ...
    { title: "Global Expansion", description: "Run multiple stores, languages, and currencies from a single NetSuite account.", image: "/images/Dashboard/Presence.webp" },
  ...
  const challenges = [
    { title: "Disjointed Systems", description: "Eliminate manual data entry and errors by unifying ecommerce with your ERP.", image: "/images/people/group3.webp" },
    { title: "Inventory Issues", description: "Prevent stockouts and overselling with real-time inventory visibility across all channels.", image: "/images/aboutus/mission.webp" },
    ...
    { title: "Legacy Tech Debt", description: "Move to a cloud-native platform that updates automatically and stays secure.", image: "/images/aboutus/value.webp" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="relative min-h-[400px] lg:min-h-[500px] rounded-3xl overflow-hidden shadow-2xl border border-gray-100">
              <Image src="/images/Dashboard/netsuitedash2.webp" alt="What is NetSuite SuiteCommerce" fill className="object-cover" />
