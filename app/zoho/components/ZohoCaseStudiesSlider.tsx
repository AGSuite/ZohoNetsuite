                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex gap-1.5">
                                                        <select
                                                            ...
                                                            onChange={handleInputChange}
                                                            className="w-[85px] px-2 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#f59e0b] outline-none text-xs font-semibold"
                                                        >
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={handleInputChange}
                                                            className="flex-1 px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-[#f59e0b] outline-none transition-all placeholder:text-slate-400"
