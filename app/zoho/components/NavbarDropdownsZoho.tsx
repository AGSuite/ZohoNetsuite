                        ...
                        <div className="space-y-5">
                            ...
                            <div className={`relative rounded-xl p-5 overflow-hidden bg-gradient-to-r ${item.title === 'Services' ? 'from-red-600 to-rose-700' :
                                ...
                                <div className="relative z-10 flex items-center justify-between">
                                    ...
                                    <Link
                                        href={item.title === 'Services' ? '/zoho/services' : item.title === 'Industries' ? '/zoho/industries' : item.title === 'Insights' ? '/zoho/blog' : item.title === 'Contact' ? '/zoho/contact/careers' : '/zoho/about-us'}
