                    ...
                    <div className="grid lg:grid-cols-2 gap-14 xl:gap-20 items-start">
                        ...
                        >
                            ...
                            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 bg-white backdrop-blur-sm w-fit shadow-lg shadow-blue-500/10">
                                ...
                                <span className="text-blue-900 text-xs font-medium tracking-widest uppercase">Precision Pricing</span>
                            </div>
                            ...
                            <div className="space-y-4">
                                <p className="text-gray-300 text-lg leading-relaxed max-w-lg">
                                    Get custom project pricing from certified Zoho strategists. Whether it's a new implementation, optimization, or complex integration, we provide bulletproof estimates.
                                </p>
                            </div>
                            ...
                            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        desc: "Transparent, SLA-backed pricing structures with no hidden costs for enterprise-grade Zoho deployments."
                                    },
                                    {
                                        step: "03",
                                        title: "Global Expertise",
                                        desc: "Access 250+ successful implementations and a team of 75+ certified Zoho consultants worldwide."
                                    },
                                    {
                                        step: "04",
                                        title: "24-Hour Callback",
                                        desc: "Our senior strategists review your quote request and connect within one business day."
                                    }
                                ].map((item, i) => (
                                    <motion.div
                                        key={i}
                                        ...
                                        >
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                                <div>
                                                    ...
                                                    <input type="text" id="Designation" name="Designation" required maxLength={100} placeholder="Manager" className="w-full bg-blue-50/50 border-2 border-blue-100 hover:border-blue-400 focus:border-blue-600 focus:ring-4 focus:ring-blue-50 rounded-xl px-4 py-3.5 text-gray-900 text-sm outline-none transition-all placeholder-gray-400" />
                                                </div>
                                                <div>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                                <div>
                                                    ...
                                                    <select id="LEADCF19" name="LEADCF19" required onChange={() => (window as any).addAriaSelected409531000047791049?.()} className="w-full bg-blue-50/50 border-2 border-blue-100 hover:border-blue-400 focus:border-blue-600 focus:ring-4 focus:ring-blue-50 rounded-xl px-4 py-3.5 text-gray-900 text-sm outline-none appearance-none cursor-pointer">
