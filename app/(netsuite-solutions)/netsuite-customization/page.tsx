...
export default function CustomizationPage() {
  ...
  const stats = [
    { label: "Custom Scripts Built", value: 500, suffix: "+", icon: Code2 },
    {
  ...
  const services = [
    {
      ...
      description:
        "Build powerful server-side and client-side automation using SuiteScript 2.x — scheduled scripts, user event scripts, workflow action scripts, and RESTlets.",
    ...
    {
      title: "SuiteFlow Workflows",
      description:
        "Design and deploy visual workflow automations for approval routing, lead assignment, invoice processing, and status-driven business logic.",
    ...
    {
      title: "Custom Forms & Records",
      description:
        "Create bespoke transaction forms, custom record types, and tailored list views that mirror your exact operational requirements inside NetSuite.",
    ...
    },
    {
      ...
      description:
        "Build custom SuiteAnalytics workbooks, pivot reports, and drill-down dashboards that surface exactly the business insight your teams need.",
    ...
    },
    {
      ...
      description:
        "Package your customisations as managed or unmanaged SuiteApps — enabling version control, safe distribution, and upgrade-resilient deployments.",
    ...
    {
      title: "SuiteTalk API Extensions",
      description:
        "Expose custom NetSuite functionality via RESTlets and SuiteTalk SOAP/REST APIs — enabling third-party apps and external systems to interact with your data.",
    ...
    },
    {
      ...
      description:
        "Design granular role-based access control, field-level permissions, and subsidiary-scoped views — keeping your data secure and your teams productive.",
    ...
    {
      title: "Custom Dashboards & KPIs",
      description:
        "Build role-specific dashboards with real-time KPI portlets, custom reminders, and quick-search tools — giving every user a personalised NetSuite home.",
    ...
    {
      title: "PDF Template Customisation",
      description:
        "Design branded, data-rich invoice, PO, sales order, and fulfilment templates using FreeMarker — tailored to your corporate identity and compliance needs.",
    ...
    },
    {
      ...
      description:
        "Embed AI-driven anomaly detection, smart approval routing, and demand-based triggers into your NetSuite workflows for next-generation process automation.",
    ...
    {
      title: "Portals & External-Facing Apps",
      description:
        "Develop customer self-service portals, vendor portals, and field-team mobile interfaces built on top of NetSuite data and logic.",
    ...
    {
      title: "Ongoing Script Maintenance",
      description:
        "Keep your SuiteScripts, workflows, and customisations healthy across NetSuite's bi-annual upgrades with proactive regression testing and issue resolution.",
  ...
  const benefits = [
    {
      title: "Upgrade-Safe Customisations",
      description:
        "We build exclusively within NetSuite's SuiteCloud platform using version-independent frameworks — so every customisation survives bi-annual upgrades without regression testing surprises.",
      image: "/images/lap/lap1.webp",
      points: [
    ...
    {
      title: "Business-Logic Precision",
      description:
        "Our SuiteCloud architects map your exact business rules — multi-tier approval chains, complex tax logic, cross-subsidiary workflows — into clean, maintainable scripts.",
      image: "/images/people/laptopgirl.webp",
      points: [
        "Detailed functional specification upfront",
        "Unit-tested script logic",
        "Edge-case handling built-in",
        "Peer-reviewed code delivery",
      ],
    },
    {
      title: "Faster Time-to-Deploy",
      description:
        "With a library of pre-built SuiteScript components and SuiteFlow templates, we accelerate your custom development cycle without cutting corners on quality.",
      image: "/images/lap/lap3.webp",
      points: [
        "Re-usable script component library",
    ...
    },
    {
      ...
      description:
        "We design role hierarchies and permission structures that enforce the principle of least privilege — protecting sensitive financial and operational data across every user type.",
      image: "/images/people/laptopmen2.webp",
      points: [
        "Subsidiary-scoped roles",
        "Field-level read/write controls",
        "Saved search access governance",
        "Quarterly access review support",
      ],
    },
    {
      title: "End-User Adoption by Design",
      description:
        "Custom forms, intuitive dashboards, and streamlined workflows are built with the end-user in mind — reducing training overhead and driving rapid adoption.",
      image: "/images/lap/lap2.webp",
      points: [
        "User journey-mapped form design",
        "Contextual inline help text",
        "Reduced-click workflow paths",
        "Role-based dashboard templates",
      ],
    },
    {
      title: "Documented & Maintainable Codebase",
      description:
        "Every SuiteScript and workflow we deliver comes with full internal documentation and a handover pack — so your team or future developers can understand and maintain it.",
      image: "/images/people/fourteam.webp",
      points: [
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Customization Services Background"
            fill
                ...
                >
                  ...
                  <div>
                    <p className="text-gray-900 text-sm font-bold leading-tight">
                      100% upgrade-safe code
                    </p>
                    <p className="text-gray-500 text-xs mt-0.5 leading-snug">
                      SuiteCloud native · Documented · Regression tested
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-[11px] mt-0.5 whitespace-nowrap">
                      SuiteScript · SuiteFlow · SuiteApps · APIs
                    </p>
                  </div>
                </motion.div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-indigo-500 leading-tight">
                NetSuite That Fits Your Business. Exactly.
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                No two businesses are identical, and standard out-of-the-box
                NetSuite rarely covers every requirement. NetSuite Customization
                means extending the platform — through SuiteScript automations,
                SuiteFlow workflows, custom records, and tailored forms — so it
                mirrors your exact processes, not the other way around.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                AGSuite's SuiteCloud developers build every customisation within
                NetSuite's native framework — ensuring your solutions are
                upgrade-safe, performant, and fully documented for long-term
                maintainability.
              </p>
              <div className="pt-4">
                <a
                ...
                >
                  <span>Start Your Customization</span>
                  <motion.span
                    className="flex items-center"
                    animate={{ x: [0, 5, 0] }}
                    transition={{
      ...
      >
        <div className="max-w-7xl mx-auto px-10 flex flex-col items-center gap-5">
          ...
          >
            ...
            platform — from automation scripts to branded PDF templates
          </motion.p>
      ...
      >
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <style>{`
            ...
            .star-cust { position:absolute; border-radius:9999px; background:white; animation: twinkle var(--tw-dur, 3s) ease-in-out infinite var(--tw-delay, 0s), drift calc(var(--tw-dur, 3s) * 2) ease-in-out infinite var(--tw-delay, 0s); }
          `}</style>
          {[
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <h3 className="text-3xl md:text-5xl font-medium mt-6 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Why Businesses Choose AGSuite for NetSuite Customization
            </h3>
          </motion.div>
            ...
            <div className="grid lg:grid-cols-[3fr_2fr] gap-0 items-stretch">
              <div className="py-12 px-10 lg:px-16 flex flex-col justify-center">
                ...
                <p className="text-white/75 text-base leading-relaxed mb-8">
                  Customization pricing depends on scope — number of scripts,
                  workflow complexity, number of custom records, and integration
                  requirements. Every project is scoped upfront with a fixed-fee
                  statement of work. Simple SuiteScript automations can be
                  delivered rapidly, while complex SuiteApp builds are phased
                  across sprints with transparent milestones.
                </p>
                <div>
                  <a
                    href="#contact-form"
            ...
            <div className="relative z-10 px-10 py-16 lg:px-20 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="text-left max-w-2xl">
                <h2 className="text-3xl md:text-5xl font-black text-white mb-4 leading-tight">
                  NetSuite Built Around{" "}
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-300">
                    Your Business.
                  </span>
                </h2>
                <p className="text-white/80 text-lg md:text-xl font-medium">
                  Stop working around your ERP. Let AGSuite tailor NetSuite to
                  match exactly how your business operates — with upgrade-safe
